          ...
          <span v-if="props.column.field == 'actions'">
            <div>
              ...
              >
                ...
                <b-dropdown-item title="PDF" @click="Invoice_Bon_PDF(props.row , props.row.id)">
                  <i class="nav-icon i-File-TXT font-weight-bold mr-2"></i>
                  {{$t('DownloadBonPdf')}}
                </b-dropdown-item>
            ...
            <tbody>
              <tr v-for="detail_invoice in invoice_pos.details">
                <td colspan="3">
                  ...
                  <br>
                  <span>{{formatNumber(detail_invoice.quantity,2)}}  x {{formatNumber(detail_invoice.total/detail_invoice.quantity,2)}}</span>
                </td>
