...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapActions)(["refreshUserPermissions"])), {}, {
    ...
    Update_Pos_Settings: function Update_Pos_Settings() {
      ...
      axios.put("pos_settings/" + this.pos_settings.id, (_axios$put = {
        note_customer: this.pos_settings.note_customer,
        show_note: this.pos_settings.show_note
      }, _defineProperty(_axios$put, "show_note", this.pos_settings.show_note), _defineProperty(_axios$put, "show_barcode", this.pos_settings.show_barcode), _defineProperty(_axios$put, "show_discount", this.pos_settings.show_discount), _defineProperty(_axios$put, "show_phone", this.pos_settings.show_phone), _defineProperty(_axios$put, "show_email", this.pos_settings.show_email), _defineProperty(_axios$put, "show_address", this.pos_settings.show_address), _defineProperty(_axios$put, "show_customer", this.pos_settings.show_customer), _axios$put)).then(function (response) {
...
var render = function render() {
  ...
  }, [_vm._v("\n                       " + _vm._s(_vm.$t("CustomrtIce")) + "\n                        "), _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.pos_settings.show_ice,
      expression: "pos_settings.show_ice"
    }],
    attrs: {
      type: "checkbox"
    },
    domProps: {
      checked: Array.isArray(_vm.pos_settings.show_ice) ? _vm._i(_vm.pos_settings.show_ice, null) > -1 : _vm.pos_settings.show_ice
    },
    on: {
      change: function change($event) {
        var $$a = _vm.pos_settings.show_ice,
            $$el = $event.target,
        ...
        if (Array.isArray($$a)) {
          ...
          if ($$el.checked) {
            $$i < 0 && _vm.$set(_vm.pos_settings, "show_ice", $$a.concat([$$v]));
          } else {
            $$i > -1 && _vm.$set(_vm.pos_settings, "show_ice", $$a.slice(0, $$i).concat($$a.slice($$i + 1)));
          }
        } else {
          _vm.$set(_vm.pos_settings, "show_ice", $$c);
        }
      }
    }
  }), _vm._v(" "), _c("span", {
