...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    Selected_Purchase_Ref: function Selected_Purchase_Ref(value) {
      this.Get_Products_By_purchase(value);
    },
    //------------------------------------ Get Products By purchase -------------------------\\
    Get_Products_By_purchase: function Get_Products_By_purchase(id) {
      var _this2 = this;

      // Start the progress bar.
      nprogress__WEBPACK_IMPORTED_MODULE_0___default().start();
      nprogress__WEBPACK_IMPORTED_MODULE_0___default().set(0.1);
      axios.get("get_Products_by_purchase/" + id).then(function (response) {
        _this2.details = response.data.details;
        _this2.purchase_return = response.data.purchase_return;
        _this2.purchase_return.date = new Date().toISOString().slice(0, 10);
    ...
    Create_Return_Purchase: function Create_Return_Purchase() {
      ...
      if (this.verifiedForm()) {
        ...
        axios.post("returns/purchase", {
          ...
          _this3.makeToast("success", _this3.$t("Create.TitleReturn"), _this3.$t("Success"));
...
var render = function render() {
  ...
  return _c("div", {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref) {
        ...
        return _c("b-form-group", {
          ...
          on: {
            input: _vm.Selected_Purchase_Ref
          },
          model: {
            value: _vm.purchase_return.purchase_id,
            callback: function callback($$v) {
              _vm.$set(_vm.purchase_return, "purchase_id", $$v);
            },
            expression: "purchase_return.purchase_id"
          }
        }), _vm._v(" "), _c("b-form-invalid-feedback", [_vm._v(_vm._s(errors[0]))])], 1);
      }
    }], null, false, 1361416434)
  })], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-3",
    attrs: {
      lg: "4",
    ...
    }, [_vm._v(_vm._s(detail.purchase_quantity) + " " + _vm._s(detail.unitPurchase))])]), _vm._v(" "), _c("td", [_c("div", {
