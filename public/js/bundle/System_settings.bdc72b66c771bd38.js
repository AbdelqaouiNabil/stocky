  ...
  data: function data() {
    ...
    return {
      ...
      setting: (_setting = {
        ...
        logo: "",
        CompanyName: ""
      }, _defineProperty(_setting, "CompanyName", ""), _defineProperty(_setting, "CompanyPhone", ""), _defineProperty(_setting, "CompanyAdress", ""), _defineProperty(_setting, "footer", ""), _defineProperty(_setting, "developed_by", ""), _defineProperty(_setting, "default_language", ""), _defineProperty(_setting, "sms_gateway", ""), _defineProperty(_setting, "is_invoice_footer", ''), _defineProperty(_setting, "invoice_footer", ''), _setting)
    };
  },
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(validationContext) {
        return [_c("b-form-group", {
          ...
          model: {
            value: _vm.setting.ice,
            callback: function callback($$v) {
              _vm.$set(_vm.setting, "ice", $$v);
            },
            expression: "setting.ice"
          }
        })], 1)];
      }
    }], null, false, 444963545)
  })], 1), _vm._v(" "), _c("b-col", {
    attrs: {
      lg: "4",
      md: "4",
