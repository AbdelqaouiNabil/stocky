...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapActions)(["refreshUserPermissions"])), {}, {
    ...
    Update_Pos_Settings: function Update_Pos_Settings() {
      ...
      }, _defineProperty(_axios$put, "show_note", this.pos_settings.show_ice), _defineProperty(_axios$put, "show_barcode", this.pos_settings.show_barcode), _defineProperty(_axios$put, "show_discount", this.pos_settings.show_discount), _defineProperty(_axios$put, "show_phone", this.pos_settings.show_phone), _defineProperty(_axios$put, "show_email", this.pos_settings.show_email), _defineProperty(_axios$put, "show_address", this.pos_settings.show_address), _defineProperty(_axios$put, "show_customer", this.pos_settings.show_customer), _axios$put)).then(function (response) {
