...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_6__.mapActions)(["changeSidebarProperties", "changeThemeMode", "logout"])), (0,vuex__WEBPACK_IMPORTED_MODULE_6__.mapGetters)(["currentUser"])), {}, (_objectSpread2 = {
    ...
    if (this.details.some(function (detail) {
      ...
      this.increment_qty_scanner(code); // Complete the animation of theprogress bar.
            ...
            case 3:
              ...
              if (error) {
                ...
                axios.post("pos/create_pos", {
                  ...
                  _this14.paymentProcessing = false; // Complete the animation of theprogress bar.
    ...
    axios.get("products/" + product_id).then(function (response) {
      ...
      _this16.CaclulTotal(); // Complete the animation of theprogress bar.
    ...
    axios.get("pos/data_create_pos").then(function (response) {
      ...
      _this19.brands = response.data.brands; // this.pos_settings = response.data.pos_settings;
