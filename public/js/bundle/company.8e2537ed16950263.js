...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    Create_Company: function Create_Company() {
      ...
      axios.post("company", (_axios$post = {
        name: this.company.name
      }, _defineProperty(_axios$post, "name", this.company.name), _defineProperty(_axios$post, "email", this.company.email), _defineProperty(_axios$post, "country", this.company.country), _defineProperty(_axios$post, "phone", this.company.phone), _axios$post)).then(function (response) {
