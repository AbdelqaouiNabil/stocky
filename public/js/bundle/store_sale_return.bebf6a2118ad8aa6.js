...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    //---------------------- Event Select sale ------------------------------\\
    Selected_Sale_Ref: function Selected_Sale_Ref(value) {
      this.Get_Products_By_Sale(value);
    },
    //------------------------------------ Get Products By Sale -------------------------\\
    Get_Products_By_Sale: function Get_Products_By_Sale(id) {
      var _this2 = this;

      // Start the progress bar.
      nprogress__WEBPACK_IMPORTED_MODULE_0___default().start();
      nprogress__WEBPACK_IMPORTED_MODULE_0___default().set(0.1);
      axios.get("get_Products_by_sale/" + id).then(function (response) {
        _this2.details = response.data.details;
        _this2.sale_return = response.data.sale_return;
        _this2.sale_return.date = new Date().toISOString().slice(0, 10);
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref) {
        ...
        return _c("b-form-group", {
          ...
          on: {
            input: _vm.Selected_Sale_Ref
          },
          model: {
            value: _vm.sale_return.sale_id,
            callback: function callback($$v) {
              _vm.$set(_vm.sale_return, "sale_id", $$v);
            },
            expression: "sale_return.sale_id"
          }
        }), _vm._v(" "), _c("b-form-invalid-feedback", [_vm._v(_vm._s(errors[0]))])], 1);
      }
    }], null, false, 1630268130)
  })], 1), _vm._v(" "), _c("b-col", {
    staticClass: "mb-3",
    attrs: {
      lg: "4",
