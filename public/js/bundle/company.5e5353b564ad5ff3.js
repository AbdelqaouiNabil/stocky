...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    Update_Company: function Update_Company() {
      ...
      this.SubmitProcessing = true;
      axios.put("company/" + this.company.id, (_axios$put = {
        name: this.company.name
      }, _defineProperty(_axios$put, "name", this.company.name), _defineProperty(_axios$put, "email", this.company.email), _defineProperty(_axios$put, "country", this.company.country), _defineProperty(_axios$put, "phone", this.company.phone), _axios$put)).then(function (response) {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(validationContext) {
        return [_c("b-form-group", {
          ...
          model: {
            value: _vm.company.ice,
            callback: function callback($$v) {
              _vm.$set(_vm.company, "ice", $$v);
            },
            expression: "company.ice"
          }
        }), _vm._v(" "), _c("b-form-invalid-feedback", {
          attrs: {
            id: "Name-feedback"
